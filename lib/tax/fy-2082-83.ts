// =============================================================================
// Nepal Salary Tax — Fiscal Year 2082/83 (Shrawan 2082 → Ashadh 2083)
//
// Source: Finance Act 2082 (Income Tax Act 2058 as amended).
//
// !!  VERIFY before deploy: cross-check the slab boundaries and rates against  !!
// !!  your latest IRD reference. This file is the single source of truth.      !!
//
// What changed vs FY 2081/82:
// - The "above Rs 20,00,000" slab was split into two:
//     * Rs 20,00,001 – Rs 50,00,000 — 36% effective (30% base + 20% surcharge)
//     * Above Rs 50,00,000          — 39% effective (30% base + 30% surcharge)
//
// Notes baked in:
...
// - Deduction caps below are statutory maxima from Finance Act 2082.
// =============================================================================
...
export const SLABS: Record<FilingStatus, Slab[]> = {
  single: [
    ...
    { from: 2_000_000, to: 5_000_000, rate: 0.36, label: 'Rs 20,00,001 – 50,00,000 (30% + 20% surcharge)' },
    { from: 5_000_000, to: null,      rate: 0.39, label: 'Above Rs 50,00,000 (30% + 30% surcharge)' },
  ],
  couple: [
...
/** Statutory deduction caps per Finance Act 2082. */
 ...
 * read alongside common Nepal CA practice.
 */
